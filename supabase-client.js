// supabase-client.js
// Replace these values if you want to use a different Supabase project
...
(function initSupabase(){
  if (!window.supabase || !window.supabase.createClient) {
    console.warn('Supabase SDK must be loaded before supabase-client.js. Include: <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script>');
    return;
  }
